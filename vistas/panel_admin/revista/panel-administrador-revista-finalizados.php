...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href=""><i class="fa fa-newspaper-o"></i> <span>Revista</span></a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="panel-administrador-revista-finalizados.php"><i class="fa fa-circle-o"></i>Finalizados</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Revista - Revistas finalizadas
        <small>Muestra de revistas finalizadas</small>
      </h1>
    </section>
            ...
            <div class="table-responsive">
             <table id="tabla1" class="table table-bordered table-hover">
                 ...
                 <thead>
                  ...
                  <?php include("../../../php/panel_admin/revista/finalizado/tabla_finalizado.php"); ?>
                   </tbody>
