                                  ...
                                  <div class="modal-body">
                                          <form class="cmxform" action="../../php/editar_usuario.php" method="POST" class="form-horizontal">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" id="id_usuario" name="id_usuario" class="form-control input-largo" value="'.$fila["id_cliente"].'" readonly="readonly" />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="password" name="password" id="password" class="form-control input-largo" value="'.$fila["clave_cliente"].'" />
                                                </div>
                                                <div class="form-group">
